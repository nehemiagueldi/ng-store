      ...
      <div class="px-5 mb-5 md:px-16 lg:px-32">
        ...
        <div class="mockup-window border bg-base-300">
          <div class="flex justify-center flex-col items-center px-4 py-5 bg-base-200">
            <!-- TITLE AND PRICE -->
            <h1 class="text-center font-bold text-2xl md:text-3xl mb-3 uppercase">DiKontrak Rumah Daerah Bogor</h1>
            <h1 class="text-center font-bold text-xl md:text-3xl mb-3 uppercase">Rp 38.000.000/tahun</h1>
            ...
            <div class="mt-4 space-y-3 text-sm lg:text-base">
              <!-- DETAIL 1 -->
              <div>
                <h2 class="font-semibold text-lg md:text-xl text-center md:text-left uppercase">DiKontrak Rumah 1 Lantai Daerah Bogor Strategis dengan Suasana Tenang dan Nyaman</h2>
                <p class="text-accent font-mono">> Lokasi : Perumahan Kemang Regency Blok K8 No.20 RT 03/RW 20 Katulampa, Bantarkemang, Kota Bogor, Bogor Timur, Jawa Barat</p>
                <p class="text-accent font-mono">> Luas Tanah : 128 m2</p>
                <p class="text-accent font-mono">> Luas Bangunan : 58 m2</p>
                ...
                <p class="text-accent font-mono">> Dekat dengan Tol Bogor Selatan</p>
                <p class="text-accent font-mono">> Dekat dengan Summarecon Bogor</p>
              </div>
              ...
              <div>
                ...
                <NuxtLink to="https://goo.gl/maps/KFYK3NruH3tN82kB7" target="_blank">
                  <img src="/lokasirumahkemangregency.png" alt="Lokasi Rumah" class="w-96 mx-auto hover:scale-105 duration-300 transition ease-in-out justify-center rounded-md object-cover" />
                </NuxtLink>
              </div>
              ...
              <div class="text-center">
                ...
                <NuxtLink class="btn btn-accent mt-2" target="_blank" to="https://wa.me/6285155012135?text=Halo, Saya ingin bertanya mengenai Kontrakan Rumah Daerah Kemang Regency Blok K8 No 20 Bapak"> <img width="24" height="24" src="https://img.icons8.com/3d-fluency/94/whatsapp.png" alt="whatsapp" /> Contact Seller </NuxtLink>
